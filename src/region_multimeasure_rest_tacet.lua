...
-- USER VARIABLES--
local tacet_text = "TACET" -- The text of TACET expressions created by the script
local tacet_description = "TACET for Multimeasure Rests"
local al_fine_text = "tacet al fine"
...
function tacet_mm()
    ...
    --local full_document = finenv.Region()
    --full_document:SetFullDocument()
