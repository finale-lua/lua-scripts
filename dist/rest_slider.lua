...
function plugindef()
    ...
    finaleplugin.RTFNotes = [[
        ...
        {\pard \sl264 \slmult1 \ql \f0 \sa180 \li0 \fi0 Slide rests up and down on the nominated layer with continuous visual feedback. If a single staff is selected then the {\b Mid-Staff Above} and {\b Mid-Staff Below} buttons align rests midway between adjacent staves with one click. (The {\b midpoint} is measured in {\b Page View} and may look different in {\b Scroll View}). {\b Cancel} the action to leave rests unchanged.\par}
        ...
        {\pard \sl264 \slmult1 \ql \f0 \sa180 \li0 \fi0 At startup all rests in the chosen layer are moved to the same offset as the first rest on that layer. Rests can be changed on multiple layers in the one action.\par}
        ...
        {\pard \sl264 \slmult1 \ql \f0 \sa0 \li1080 \fi-360 \bullet \tx360\tab {\b d}: shift to mid-staff above (if one staff selected)\par}
        {\pard \sl264 \slmult1 \ql \f0 \sa0 \li1080 \fi-360 \bullet \tx360\tab {\b f}: shift to mid-staff below (if one staff selected)\par}
        {\pard \sl264 \slmult1 \ql \f0 \sa0 \li1080 \fi-360 \bullet \tx360\tab {\b z}: reset to \u8220"zero\u8221" shift (not floating)\par}
        {\pard \sl264 \slmult1 \ql \f0 \sa0 \li1080 \fi-360 \bullet \tx360\tab {\b x}: make floating\par}
