...
function plugindef()
    ...
    finaleplugin.RTFNotes = [[
        ...
        {\pard \sl264 \slmult1 \ql \f0 \sa180 \li0 \fi0 This script automatically creates a \u8220"jet\u233?\u8221"-style bowing effect. These mimic examples shown on p.\u160?404 of \u8220"Behind Bars\u8221" by Elaine Gould. For the best results with staccato dots, use an articulation with \u8220"Avoid Staff Lines\u8221" unchecked.\par}
        ...
        {\pard \sl264 \slmult1 \ql \f0 \sa180 \li0 \fi0 The steps to use this script are:\par}
        {\pard \sl264 \slmult1 \ql \f0 \sa0 \li360 \fi-360 1.\tx360\tab Add the notes you want to display, with or without accidentals. Normally you choose notes with noteheads that follow a straight-line path as closely as possible. They can be reduced size or grace notes.\par}
        {\pard \sl264 \slmult1 \ql \f0 \sa0 \li360 \fi-360 2.\tx360\tab Add staccato dots if you want them.\par}
        {\pard \sl264 \slmult1 \ql \f0 \sa0 \li360 \fi-360 3.\tx360\tab Add a slur if you want it.\par}
        {\pard \sl264 \slmult1 \ql \f0 \sa0 \li360 \fi-360 4.\tx360\tab Run the script on the pattern you just entered.\sa180\par}
        {\pard \sl264 \slmult1 \ql \f0 \sa180 \li0 \fi0 The script takes the following actions:\par}
        {\pard \sl264 \slmult1 \ql \f0 \sa0 \li360 \fi-360 1.\tx360\tab Searches for a selected pattern, skipping rests at the beginning and stopping at the first rest it encounters.\par}
        {\pard \sl264 \slmult1 \ql \f0 \sa0 \li360 \fi-360 2.\tx360\tab Hides the noteheads on all but the first and (optionally) last entry.\par}
        {\pard \sl264 \slmult1 \ql \f0 \sa0 \li360 \fi-360 3.\tx360\tab Hides accidentals on any noteheads that were hidden.\par}
        {\pard \sl264 \slmult1 \ql \f0 \sa0 \li360 \fi-360 4.\tx360\tab Aligns the staccato dots in a straight line path. (The path may not be exactly straight if the articulation is set to avoid staff lines.)\par}
        {\pard \sl264 \slmult1 \ql \f0 \sa0 \li360 \fi-360 5.\tx360\tab Adds a gliss mark (tab slide) between the first and last notes, if one does not already exist. If you have entered parallel chords, it adds a gliss mark for each note in the chord.\sa180\par}
        ...
        {\pard \sl264 \slmult1 \ql \f0 \sa180 \li0 \fi0 To use a configuration file:\par}
        {\pard \sl264 \slmult1 \ql \f0 \sa0 \li360 \fi-360 1.\tx360\tab If it does not exist, create a subfolder called {\f1 script_settings} in the folder where this script resides.\par}
        {\pard \sl264 \slmult1 \ql \f0 \sa0 \li360 \fi-360 2.\tx360\tab Create a text file in the {\f1 script_settings} folder called {\f1 note_automatic_jete.config.txt}.\par}
        {\pard \sl264 \slmult1 \ql \f0 \sa0 \li360 \fi-360 3.\tx360\tab Add either or both of the following lines to it.\sa180\par}
        {\pard \sl264 \slmult1 \ql \f0 \sa180 \li0 \fi0 \f1 dot_character = 46           -- This may be any character code you wish to search use, including a SMuFL character code.\line
