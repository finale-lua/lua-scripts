...
function plugindef()
    ...
    finaleplugin.RTFNotes = [[
        ...
        {\pard \sl264 \slmult1 \ql \f0 \sa180 \li0 \fi0 Recursively upgrades every .mus or .musx file in a selected folder tree to Finale 27 .musx format.\par}
        {\pard \sl264 \slmult1 \ql \f0 \sa180 \li0 \fi0 Upgraded files are written into a sibling subfolder named \u8220"-finale27\u8221" inside each source folder. That subfolder is skipped during traversal, so rerunning the script will not reprocess prior output.\par}
        {\pard \sl264 \slmult1 \ql \f0 \sa180 \li0 \fi0 The script leaves source files unchanged. Existing upgraded files are overwritten on each run.\par}
        }
    ]]
    finaleplugin.HashURL = "https://raw.githubusercontent.com/finale-lua/lua-scripts/master/hash/document_upgrade_folder_to_finale_27.hash"
