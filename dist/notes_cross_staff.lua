...
function plugindef()
    ...
    finaleplugin.RTFNotes = [[
        ...
        {\pard \sl264 \slmult1 \ql \f0 \sa0 \li1080 \fi-360 \bullet \tx360\tab {\b x}: set default {\b shift} values\par}
        {\pard \sl264 \slmult1 \ql \f0 \sa0 \li1080 \fi-360 \bullet \tx360\tab {\b v}: set zero {\b shift} values\par}
        {\pard \sl264 \slmult1 \ql \f0 \sa0 \li1080 \fi-360 \bullet \tx360\tab {\b m}: toggle {\b Modeless}\par}
        {\pard \sl264 \slmult1 \ql \f0 \sa0 \li1080 \fi-360 \bullet \tx360\tab {\b q}: display these script notes\line \par}
    ...
    for entry in eachentrysaved(rgn, config.layer_num) do
        ...
        if entry:IsNote() then
            ...
            if (beamed or not config.not_unbeamed) then
                ...
                if count <= config.count_notes then
        ...
        if count >= config.count_out_of then count = 0 end
    end
