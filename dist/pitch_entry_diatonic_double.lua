...
function plugindef()
    ...
    finaleplugin.RTFNotes = [[
        ...
        {\pard \sl264 \slmult1 \ql \f0 \sa180 \li0 \fi0 Notes and chords in the current music selection are {\b doubled} (duplicated) either up or down by the chosen diatonic interval. Affect all layers or just one. To repeat the last action without a confirmation dialog use the {\i Repeat} menu or hold down [Shift] when starting the script.\par}
        {\pard \sl264 \slmult1 \ql \f0 \sa180 \li0 \fi0 Select {\b Modeless} if you prefer the dialog window to \u8220"float\u8221" above your score and you can change the score selection while it floats. In this mode click {\b Apply} [Return/Enter] to double pitches and {\b Cancel} [Escape] to close the window. Cancelling {\b Modeless} will apply the {\i next} time you use the script.\par}
        {\pard \sl264 \slmult1 \ql \f0 \sa180 \li720 \fi0 These key commands are available\line if a \u8220"numeric\u8221" field is highlighted:\par}
        {\pard \sl264 \slmult1 \ql \f0 \sa0 \li1080 \fi-360 \bullet \tx360\tab {\b z}: toggle up/down\par}
        ...
        {\pard \sl264 \slmult1 \ql \f0 \sa0 \li1080 \fi-360 \bullet \tx360\tab (delete key not needed in numeric fields)\sa180\par}
        }
    ]]
...
local function run_the_dialog()
    ...
    dialog:RegisterHandleOkButtonPressed(function()
        config.interval = tonumber(save.interval)
