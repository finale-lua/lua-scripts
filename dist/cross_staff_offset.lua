...
function plugindef()
    ...
    finaleplugin.RTFNotes = [[
        ...
        {\pard \sl264 \slmult1 \ql \f0 \sa180 \li0 \fi0 When crossing notes to adjacent staves the stems of {\i crossed} notes can be reversed (on the \u8220"wrong\u8221" side of the notehead) and look misaligned by the width of a notehead, nominally 24 EVPUs (0.08333 inches). This script shifts cross-staffed notes horizontally to correct the spacing, with a matching offset for uncrossed notes, acting on one or all layers.\par}
        {\pard \sl264 \slmult1 \ql \f0 \sa180 \li0 \fi0 It is also a quick way to reset the horizontal position of all notes to zero. To repeat your last settings without a confirmation dialog hold down [Shift] when starting the script.\par}
