...
function plugindef()
    ...
    finaleplugin.RTFNotes = [[
        ...
        {\pard \sl264 \slmult1 \ql \f0 \sa180 \li0 \fi0 This script changes tuplets in the current selection in 24 ways on all or nominated layers. It provides an ordered list of options, each line starting with a configurable {\i hotkey}. Start the script, type the {\i hotkey} and hit [Return].\par}
        {\pard \sl264 \slmult1 \ql \f0 \sa180 \li0 \fi0 To repeat the same tuplet change as last time without a confirmation dialog, select the {\b Tuplet Chooser Repeat} menu or hold down [Shift] when starting the script.\par}
        }
    ]]
