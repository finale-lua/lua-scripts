...
function delete_selected(delete_type)
    ...
    if delete_type == "user_selects" then
    ...
    elseif string.find(delete_type, "shape") then
    ...
    elseif delete_type == "continuous_midi" then
    ...
    elseif delete_type == "staff_styles" then
        ...
        for entry in eachentrysaved(rgn) do
            ...
            if string.find(delete_type, "artic") and entry.ArticulationFlag then
            ...
            elseif delete_type == "entry_midi" and entry.PerformanceDataFlag then
            ...
            elseif delete_type == "cross_staff" then
                ...
                entry.ManualPosition = 0
                if entry.ReverseStem then entry.ReverseStem = false end
...
function user_chooses()
    ...
    local reassign = dialog:CreateButton(y_off, box_high + 30)
        :SetText("Reassign Keys"):SetWidth(y_off * 2)
