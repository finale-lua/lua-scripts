...
function plugindef()
    ...
    finaleplugin.RTFNotes = [[
        ...
        {\pard \ql \f0 \sa180 \li0 \fi0 Hold down [Shift] when opening the script to repeat your last choices without a confirmation dialog. Layer number is \u8220"clamped\u8221" to a single character so to change layer just type a new number - delete key not needed.\par}
        }
    ]]
