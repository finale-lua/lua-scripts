function plugindef()
    ...
    return "Move Lyric Baselines Down", "Move Lyrics Baselines Down",
...
function lyrics_baseline_move_down()
    ...
    for i = system_number, lastSys_number, 1 do
        ...
        for lyric_info, _ in pairs(valid_lyric_nums) do
            ...
            for j = start_slot, end_slot do
                ...
                bl.VerticalOffset = bl.VerticalOffset - config.nudge_down_evpus
                bl:Save()
            end
        end
    end
